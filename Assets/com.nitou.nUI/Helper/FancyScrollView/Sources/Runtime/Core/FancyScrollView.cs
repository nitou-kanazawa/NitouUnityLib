...
// [参考]
//  _: FancyScrollView x Shader https://docs.google.com/presentation/d/1sJIKAhFSee021hjK7gzH7cRzsE9Vbazku8OdFt0w22o/edit#slide=id.g5d169e65ba_11_175
//  Hatena: スクロールビューでもシェーダー芸がしたい！ https://setchi.hatenablog.com/entry/2019/06/23/214635
...
namespace FancyScrollView {
    ...
    public abstract class FancyScrollView<TItemData, TContext> : MonoBehaviour where TContext : class, new() {
        ...
        /// </summary>
        [Range(1e-2f, 1f)]
        [SerializeField] protected float cellInterval = 0.2f;
        ...
        /// </remarks>
        [Range(0f, 1f)]
        [SerializeField] protected float scrollOffset = 0.5f;
