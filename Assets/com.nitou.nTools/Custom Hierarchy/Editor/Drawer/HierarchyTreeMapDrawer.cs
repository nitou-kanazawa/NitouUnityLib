    ...
    public class HierarchyTreeMapDrawer : HierarchyDrawer {
        ...
        public static Texture2D TreeMapCurrent {
            get {
                ...
                tex = CustomPackageUtil.FindAssetWithPath<Texture2D>("tree_map_current.png", "Custom Hierarchy/Editor/Textures", NitouToolsConfig.pacakageInfo);
        ...
        public static Texture2D TreeMapLast {
            get {
                ...
                if (tex != null) return tex;
                tex = CustomPackageUtil.FindAssetWithPath<Texture2D>("tree_map_last.png", "Custom Hierarchy/Editor/Textures", NitouToolsConfig.pacakageInfo);
        ...
        public static Texture2D TreeMapLevel {
            get {
                ...
                if (tex != null) return tex;
                tex = CustomPackageUtil.FindAssetWithPath<Texture2D>("tree_map_level.png", "Custom Hierarchy/Editor/Textures", NitouToolsConfig.pacakageInfo);
        ...
        public static Texture2D TreeMapLine {
            get {
                ...
                if (tex != null) return tex;
                tex = CustomPackageUtil.FindAssetWithPath<Texture2D>("tree_map_line.png", "Custom Hierarchy/Editor/Textures", NitouToolsConfig.pacakageInfo);
